...
reveal = os.getcwd()
workbook = openpyxl.load_workbook('Base de datos_Fibravena-13.xlsx')
sheet = workbook['BD']
...
for j in range(1, column + 1):
    ...
    if j == 8:
        sheet.cell(2, j).value = 'CCF13000' + input('Ingrese número de Lote: ')
    if j == 9:
    ...
    if j == 21:
        sheet.cell(2, j).value = 'elaborado a partir de PROTAVENA, lote n°'
    sheet.cell(2, 22).value = input('Elaborado a partir de lote: ')
workbook.save('Base de datos_Fibravena-13.xlsx')
