...
class FIB():
    ...
    def fibravena(self):
        ...
        customer_frame = tk.LabelFrame(self.dialogo2, text='Etiqueta Fibravena', font='Sunday', height=2, fg='#FFFFFF', bg='#5475B1', bd=0)
    ...
    def base_etq(self):
        ...
        for j in range(1, column + 1):
            ...
            if j == 7:
                sheet.cell(2, j).value = 'CCF13000' + str(cant_lotes)
            if j == 8:
